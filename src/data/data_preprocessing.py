...
def normalize_text(df):
    ...
    try:
        df['Sentence'] = df['Sentence'].apply(preprocess_comment)
...
def main():
    try:
        ...
        train_data = pd.read_csv('./src/datasets/raw/train.csv')
        test_data = pd.read_csv('./src/datasets/raw/test.csv')
        ...
        save_data(train_processed_data, test_processed_data, data_path='./src/datasets')
    except Exception as e:
